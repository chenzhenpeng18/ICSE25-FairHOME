...
if __name__ == "__main__":
    ...
    performance_index = ['accuracy', 'recall', 'precision', 'f1score', 'mcc', 'spd0', 'aod0', 'eod0', 'spd1',
                         'aod1', 'eod1', 'spd2', 'aod2', 'eod2', 'wcspd', 'wcaod', 'wceod', 'avespd', 'aveaod',
                         'aveeod']
    ...
    for i in range(repeat_time):
        ...
        zero_zero_zero_zero = len(dataset_orig_train[(dataset_orig_train['Probability'] == 0) & (
                dataset_orig_train[protected_attribute1] == 0)
                                                     & (dataset_orig_train[protected_attribute2] == 0) & (
                                                                 dataset_orig_train[protected_attribute3] == 0)])
        ...
        one_one_one_zero = len(dataset_orig_train[
                                   (dataset_orig_train['Probability'] == 1) & (
                                               dataset_orig_train[protected_attribute1] == 1)
                                   & (dataset_orig_train[protected_attribute2] == 1) & (
                                               dataset_orig_train[protected_attribute3] == 0)])
        ...
        zero_zero_zero_one = len(dataset_orig_train[(dataset_orig_train['Probability'] == 0) & (
                dataset_orig_train[protected_attribute1] == 0)
                                                    & (dataset_orig_train[protected_attribute2] == 0) & (
                                                                dataset_orig_train[protected_attribute3] == 1)])
        ...
        maximum = max(zero_zero_zero_zero, zero_zero_one_zero, zero_one_zero_zero, zero_one_one_zero,
                      one_zero_zero_zero, one_zero_one_zero, one_one_zero_zero, one_one_one_zero, zero_zero_zero_one,
                      zero_zero_one_one, zero_one_zero_one, zero_one_one_one, one_zero_zero_one, one_zero_one_one,
                      one_one_zero_one, one_one_one_one)
        ...
        df = pd.concat([df_zero_zero_zero_zero, df_zero_zero_one_zero, df_zero_one_zero_zero, df_zero_one_one_zero,
                        df_one_zero_zero_zero, df_one_zero_one_zero, df_one_one_zero_zero, df_one_one_one_zero,
                        df_zero_zero_zero_one, df_zero_zero_one_one, df_zero_one_zero_one, df_zero_one_one_one,
