...
approach_list = ['fairhome', 'fairhome4', 'fairhome5']
task_list = ['compas_new']
...
for j in model_list:
    for name in ['origin','fairhome', 'fairhome4', 'fairhome5']:
...
for name in ['fairhome', 'fairhome4', 'fairhome5']:
    fout.write(name)
