...
def wc_spd(dataset_test, dataset_test_pred, p_attrs):
    ...
    num1 = len(dataset_test_pred[(dataset_test_pred[attr1] == 0) & (dataset_test_pred[attr2] == 0) & (
                dataset_test_pred[attr3] == 0) & (dataset_test_pred[labelname] == 1)]) / len(
        dataset_test_pred[
            (dataset_test_pred[attr1] == 0) & (dataset_test_pred[attr2] == 0) & (dataset_test_pred[attr3] == 0)])
    num2 = len(dataset_test_pred[(dataset_test_pred[attr1] == 0) & (dataset_test_pred[attr2] == 1) & (
                dataset_test_pred[attr3] == 0) & (dataset_test_pred[labelname] == 1)]) / len(
        dataset_test_pred[
            (dataset_test_pred[attr1] == 0) & (dataset_test_pred[attr2] == 1) & (dataset_test_pred[attr3] == 0)])
    num3 = len(dataset_test_pred[(dataset_test_pred[attr1] == 1) & (dataset_test_pred[attr2] == 0) & (
                dataset_test_pred[attr3] == 0) & (dataset_test_pred[labelname] == 1)]) / len(
        dataset_test_pred[
            (dataset_test_pred[attr1] == 1) & (dataset_test_pred[attr2] == 0) & (dataset_test_pred[attr3] == 0)])
    num4 = len(dataset_test_pred[(dataset_test_pred[attr1] == 1) & (dataset_test_pred[attr2] == 1) & (
                dataset_test_pred[attr3] == 0) & (dataset_test_pred[labelname] == 1)]) / len(
        dataset_test_pred[
            (dataset_test_pred[attr1] == 1) & (dataset_test_pred[attr2] == 1) & (dataset_test_pred[attr3] == 0)])
    ...
    return max([num1, num2, num3, num4, num5, num6, num7, num8]) - min([num1, num2, num3, num4, num5, num6, num7, num8])

def ave_spd(dataset_test, dataset_test_pred, p_attrs):
    attr1 = p_attrs[0]
    attr2 = p_attrs[1]
    attr3 = p_attrs[2]
    favorlabel = dataset_test.favorable_label
    ...
    num8 = len(dataset_test_pred[(dataset_test_pred[attr1] == 1) & (dataset_test_pred[attr2] == 1) & (
        ...
        dataset_test_pred[
            (dataset_test_pred[attr1] == 1) & (dataset_test_pred[attr2] == 1) & (dataset_test_pred[attr3] == 1)])
    return mean([abs(num1-num_average),abs(num2-num_average),abs(num3-num_average),abs(num4-num_average),abs(num5-num_average),abs(num6-num_average),abs(num7-num_average),abs(num8-num_average)])
...
def wc_aaod(dataset_test, dataset_test_pred, p_attrs):
    ...
    num_list = []
    if len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 0)& (dataset_test[labelname] == 0)]) != 0 and len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 0)& (dataset_test_pred[attr3] == 0) & (dataset_test[labelname] == 1)]) !=0:
        num1 = len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 0)& (dataset_test[labelname] == 0) & (dataset_test['pred' + labelname] == 1)]) / len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 0)& (dataset_test[labelname] == 0)]) + len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 0)& (dataset_test_pred[attr3] == 0) & (dataset_test[labelname] == 1) & (dataset_test['pred' + labelname] == 1)]) / len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 0)& (dataset_test_pred[attr3] == 0) & (dataset_test[labelname] == 1)])
        num_list.append(num1)
    if len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 1)& (dataset_test_pred[attr3] == 0) & (dataset_test[labelname] == 0)]) != 0 and len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 1)& (dataset_test_pred[attr3] == 0) & (dataset_test[labelname] == 1)])!=0:
        num2 = len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 0)& (dataset_test[labelname] == 0) & (dataset_test['pred' + labelname] == 1)]) / len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 1)& (dataset_test_pred[attr3] == 0) & (dataset_test[labelname] == 0)]) + len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 1)& (dataset_test_pred[attr3] == 0) & (dataset_test[labelname] == 1) & (dataset_test['pred' + labelname] == 1)]) / len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 1)& (dataset_test_pred[attr3] == 0) & (dataset_test[labelname] == 1)])
        num_list.append(num2)
    if len(dataset_test[(dataset_test[attr1] == 1) & (dataset_test[attr2] == 0)& (dataset_test_pred[attr3] == 0) & (dataset_test[labelname] == 0)]) != 0 and len(dataset_test[(dataset_test[attr1] == 1) & (dataset_test[attr2] == 0)& (dataset_test_pred[attr3] == 0) & (dataset_test[labelname] == 1)])!=0:
        num3 = len(dataset_test[(dataset_test[attr1] == 1) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 0)& (dataset_test[labelname] == 0) & (dataset_test['pred' + labelname] == 1)]) / len(dataset_test[(dataset_test[attr1] == 1) & (dataset_test[attr2] == 0)& (dataset_test_pred[attr3] == 0) & (dataset_test[labelname] == 0)]) + len(dataset_test[(dataset_test[attr1] == 1) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 0)& (dataset_test[labelname] == 1) & (dataset_test['pred' + labelname] == 1)]) / len(dataset_test[(dataset_test[attr1] == 1) & (dataset_test[attr2] == 0)& (dataset_test_pred[attr3] == 0) & (dataset_test[labelname] == 1)])
        num_list.append(num3)
    if len(dataset_test[(dataset_test[attr1] == 1) & (dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 0) & (
            dataset_test[labelname] == 0)]) != 0 and len(dataset_test[
                                                             (dataset_test[attr1] == 1) & (dataset_test[attr2] == 1) & (
                                                                     dataset_test_pred[attr3] == 0) & (
                                                                     dataset_test[labelname] == 1)]) != 0:
        num4 = len(dataset_test[
                       (dataset_test[attr1] == 1) & (dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 0) & (
                                   dataset_test[labelname] == 0) & (dataset_test['pred' + labelname] == 1)]) / len(
            dataset_test[(dataset_test[attr1] == 1) & (dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 0) & (
                        dataset_test[labelname] == 0)]) + len(dataset_test[(dataset_test[attr1] == 1) & (
                    dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 0) & (dataset_test[labelname] == 1) & (
                                                                                       dataset_test[
                                                                                           'pred' + labelname] == 1)]) / len(
            dataset_test[(dataset_test[attr1] == 1) & (dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 0) & (
                        dataset_test[labelname] == 1)])
        num_list.append(num4)
    if len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 1) & (
            dataset_test[labelname] == 0)]) != 0 and len(dataset_test[
                                                             (dataset_test[attr1] == 0) & (dataset_test[attr2] == 0) & (
                                                                     dataset_test_pred[attr3] == 1) & (
                                                                     dataset_test[labelname] == 1)]) != 0:
        num5 = len(dataset_test[
                       (dataset_test[attr1] == 0) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 1) & (
                                   dataset_test[labelname] == 0) & (dataset_test['pred' + labelname] == 1)]) / len(
            dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 1) & (
                        dataset_test[labelname] == 0)]) + len(dataset_test[(dataset_test[attr1] == 0) & (
                    dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 1) & (dataset_test[labelname] == 1) & (
                                                                                       dataset_test[
                                                                                           'pred' + labelname] == 1)]) / len(
            dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 1) & (
                        dataset_test[labelname] == 1)])
        num_list.append(num5)
    if len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 1) & (
            dataset_test[labelname] == 0)]) != 0 and len(dataset_test[
                                                             (dataset_test[attr1] == 0) & (dataset_test[attr2] == 1) & (
                                                                     dataset_test_pred[attr3] == 1) & (
                                                                     dataset_test[labelname] == 1)]) != 0:
        num6 = len(dataset_test[
                       (dataset_test[attr1] == 0) & (dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 1) & (
                                   dataset_test[labelname] == 0) & (dataset_test['pred' + labelname] == 1)]) / len(
            dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 1) & (
                        dataset_test[labelname] == 0)]) + len(dataset_test[(dataset_test[attr1] == 0) & (
                    dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 1) & (dataset_test[labelname] == 1) & (
                                                                                       dataset_test[
                                                                                           'pred' + labelname] == 1)]) / len(
            dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 1) & (
                        dataset_test[labelname] == 1)])
        num_list.append(num6)
    if len(dataset_test[(dataset_test[attr1] == 1) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 1) & (
            dataset_test[labelname] == 0)]) != 0 and len(dataset_test[
                                                            (dataset_test[attr1] == 1) & (dataset_test[attr2] == 0) & (
                                                                    dataset_test_pred[attr3] == 1) & (
                                                                    dataset_test[labelname] == 1)]) != 0:
        num7 = len(dataset_test[
                       (dataset_test[attr1] == 1) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 1) & (
                                   dataset_test[labelname] == 0) & (dataset_test['pred' + labelname] == 1)]) / len(
            dataset_test[(dataset_test[attr1] == 1) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 1) & (
                        dataset_test[labelname] == 0)]) + len(dataset_test[(dataset_test[attr1] == 1) & (
                    dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 1) & (dataset_test[labelname] == 1) & (
                                                                                       dataset_test[
                                                                                           'pred' + labelname] == 1)]) / len(
    ...
    if len(dataset_test[(dataset_test[attr1] == 1) & (dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 1) & (
            dataset_test[labelname] == 0)]) != 0 and len(dataset_test[
                                                             (dataset_test[attr1] == 1) & (dataset_test[attr2] == 1) & (
                                                                     dataset_test_pred[attr3] == 1) & (
                                                                     dataset_test[labelname] == 1)]) != 0:
        num8 = len(dataset_test[
                       (dataset_test[attr1] == 1) & (dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 1) & (
                                   dataset_test[labelname] == 0) & (dataset_test['pred' + labelname] == 1)]) / len(
            dataset_test[(dataset_test[attr1] == 1) & (dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 1) & (
                        dataset_test[labelname] == 0)]) + len(dataset_test[(dataset_test[attr1] == 1) & (
                    dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 1) & (dataset_test[labelname] == 1) & (
                                                                                       dataset_test[
                                                                                           'pred' + labelname] == 1)]) / len(
...
def ave_aaod(dataset_test, dataset_test_pred, p_attrs):
    attr1 = p_attrs[0]
    attr2 = p_attrs[1]
    attr3 = p_attrs[2]
    favorlabel = dataset_test.favorable_label
    ...
    dataset_test[labelname] = np.where(dataset_test[labelname] == favorlabel, 1, 0)
    dataset_test['pred'+labelname] = np.where(dataset_test['pred'+labelname] == favorlabel, 1, 0)
    num_average = len(dataset_test[(dataset_test[labelname] == 0) & (dataset_test['pred' + labelname] == 1)]) / len(
        dataset_test[(dataset_test[labelname] == 0)]) + len(
        dataset_test[(dataset_test[labelname] == 1) & (dataset_test['pred' + labelname] == 1)]) / len(
        dataset_test[(dataset_test[labelname] == 1)])
    num_list = []
    if len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 0)& (dataset_test[labelname] == 0)]) != 0 and len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 0)& (dataset_test_pred[attr3] == 0) & (dataset_test[labelname] == 1)]) !=0:
        num1 = len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 0)& (dataset_test[labelname] == 0) & (dataset_test['pred' + labelname] == 1)]) / len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 0)& (dataset_test[labelname] == 0)]) + len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 0)& (dataset_test_pred[attr3] == 0) & (dataset_test[labelname] == 1) & (dataset_test['pred' + labelname] == 1)]) / len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 0)& (dataset_test_pred[attr3] == 0) & (dataset_test[labelname] == 1)])
        num_list.append(num1)
    ...
    if len(dataset_test[(dataset_test[attr1] == 1) & (dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 1) & (
        ...
        num_list.append(num8)
    rlist = []
    for metricvalue in num_list:
        rlist.append(abs(metricvalue - num_average))
    return mean(rlist) / 2
...
def wc_eod(dataset_test, dataset_test_pred, p_attrs):
    ...
    dataset_test['pred' + labelname] = np.where(dataset_test['pred' + labelname] == favorlabel, 1, 0)
    num_list=[]
    if len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 0) & (
            dataset_test[labelname] == 1)]) != 0:
        num1 = len(dataset_test[
                       (dataset_test[attr1] == 0) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 0) & (
                                   dataset_test[labelname] == 1) & (dataset_test['pred' + labelname] == 1)]) / len(
            dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 0) & (
                        dataset_test[labelname] == 1)])
        num_list.append(num1)
    if len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 0) & (
            dataset_test[labelname] == 1)]) != 0:
        num2 = len(dataset_test[
                       (dataset_test[attr1] == 0) & (dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 0) & (
                                   dataset_test[labelname] == 1) & (dataset_test['pred' + labelname] == 1)]) / len(
            dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 0) & (
                        dataset_test[labelname] == 1)])
        num_list.append(num2)
    if len(dataset_test[(dataset_test[attr1] == 1) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 0) & (
            dataset_test[labelname] == 1)]) != 0:
        num3 = len(dataset_test[
                       (dataset_test[attr1] == 1) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 0) & (
                                   dataset_test[labelname] == 1) & (dataset_test['pred' + labelname] == 1)]) / len(
            dataset_test[(dataset_test[attr1] == 1) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 0) & (
                        dataset_test[labelname] == 1)])
        num_list.append(num3)
    if len(dataset_test[(dataset_test[attr1] == 1) & (dataset_test[attr2] == 1) & (dataset_test_pred[attr3] == 0) & (
            dataset_test[labelname] == 1)]) != 0:
...
def ave_eod(dataset_test, dataset_test_pred, p_attrs):
    ...
    dataset_test[labelname] = np.where(dataset_test[labelname] == favorlabel, 1, 0)
    dataset_test['pred' + labelname] = np.where(dataset_test['pred' + labelname] == favorlabel, 1, 0)
    num_average = len(dataset_test[(dataset_test[labelname] == 1) & (dataset_test['pred' + labelname] == 1)]) / len(
        dataset_test[(dataset_test[labelname] == 1)])
    num_list=[]
    if len(dataset_test[(dataset_test[attr1] == 0) & (dataset_test[attr2] == 0) & (dataset_test_pred[attr3] == 0) & (
            dataset_test[labelname] == 1)]) != 0:
...
def create_baseline(clf_name,dataset_orig,
        ...
        for degree in degrees:
            ...
            for name,o in odds.items():
                ...
                for _ in range(repetitions):
                    ...
                    spd_ave = ave_spd(dataset_orig_test, dataset_orig_test_pred, p_attrs)
                    aaod_ave = ave_aaod(dataset_orig_test, dataset_orig_test_pred, p_attrs)
                    eod_ave = ave_eod(dataset_orig_test, dataset_orig_test_pred, p_attrs)
                    ...
                    hist.append([spd, aaod, eod, spd_ave, aaod_ave, eod_ave, acc, macrop, macror, macrof1, mcc])
