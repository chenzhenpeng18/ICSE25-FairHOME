...
from Fairea_multi_Three.fairea import create_baseline
import argparse
...
res = create_baseline(clf_name,dataset_orig, data_splits=20,repetitions=20,odds=mutation_strategies,options = [0,1],
